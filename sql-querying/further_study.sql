...
-- FS3. Find all the apps that have more than 1 genre.-Looked at solution for this one
SELECT * FROM analytics 
  WHERE  array_length(genres, 1) = 2;

-- FS4. Find all the apps that have education as one of their genres.-Looked at solution for this one
SELECT * FROM analytics 
